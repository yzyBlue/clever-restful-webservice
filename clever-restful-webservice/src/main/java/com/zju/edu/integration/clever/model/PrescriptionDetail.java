...
public class PrescriptionDetail {
	...
	public int STAttribute;//皮试属性,0-不需要皮试，1-需要皮试但结果未知，2-皮试结果阳性，3-皮试结果阴性(*)
	public int ownDrugAttribute;//自带药属性,0医院用药，1自带药
	public String drugName;//药物名称(*)
	public String drugCode;//药嘱代码
	public float dosage;//剂量
